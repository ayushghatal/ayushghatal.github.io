    ...
    switch (type) {
      case "projects":
        items.forEach((item, index) => {
          sectionHTML += `
            <div class="project">
              <a href="project.html?i=${index}" class="project-name-link">
                <div class="project-name">${item.name}</div>
              </a>
              <p class="project-desc">${item.description}</p>
              <div class="project-actions">
                <a href="project.html?i=${index}" class="project-link">Read more</a>
                ${item.link ? `<a href="${item.link}" class="project-link" target="_blank">View on GitHub</a>` : ""}
              </div>
            </div>
          `;
        });
